...
## 9. Kelly Sizing + Correlation + Adaptive Thresholds (Spatial)

### Capability: `kelly-sizing`
...
### Capability: `correlation-penalty`
...
### Capability: `adaptive-thresholds`
...
## 10. Latency Tracking (`internal/engine/latency.go`, `web/`)
